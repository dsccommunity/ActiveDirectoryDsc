...
BeforeDiscovery {
    ...
    #>
    $script:dscResourceFriendlyName = 'ADFineGrainedPasswordPolicy'
...
Describe "$($script:dscResourceName)_Integration" {
    ...
    $configurationName = "$($script:dscResourceName)_CreateADFineGrainedPasswordPolicy_Config"
    ...
    Context ('When using configuration {0}' -f $configurationName) {
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.LockoutThreshold | Should -Be $ConfigurationData.AllNodes.LockoutThreshold
            $resourceCurrentState.MinPasswordAge | Should -Be $ConfigurationData.AllNodes.MinPasswordAge
            $resourceCurrentState.MaxPasswordAge | Should -Be $ConfigurationData.AllNodes.MaxPasswordAge
            $resourceCurrentState.MinPasswordLength | Should -Be $ConfigurationData.AllNodes.MinPasswordLength
    ...
    $configurationName = "$($script:dscResourceName)_RemoveADFineGrainedPasswordPolicy_Config"
