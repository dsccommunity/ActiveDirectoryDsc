...
- Changes to xActiveDirectory
  ...
  - Added a line to the "Group Managed Service Accounts need at least one Windows Server 2012 Domain Controller" to the xADManagedServiceAccount DSC resource README.
