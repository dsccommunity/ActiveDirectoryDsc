...
1. Copy the dependent modules to each of the virtual machines.
   ...
   {
       $sourceModulePath = Split-Path -Path $module.ModuleBase -Parent
       $destinationModulePath = Join-Path -Path 'C:\Program Files\WindowsPowerShell\Modules' -ChildPath $module.Name
