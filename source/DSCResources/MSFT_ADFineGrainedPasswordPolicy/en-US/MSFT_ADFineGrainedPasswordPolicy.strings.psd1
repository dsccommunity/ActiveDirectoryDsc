...
ConvertFrom-StringData @'
    ...
    ResourcePropertyValueIncorrect                  = Property '{0}' value is incorrect; expected '{1}', actual '{2}'. (ADFGPP0006)
    ResourceInDesiredState                          = Resource '{0}' is in the desired state. (ADFGPP0007)
    ResourceNotInDesiredState                       = Resource '{0}' is NOT in the desired state. (ADFGPP0008)
    ResourceConfiguration                           = Resource '{0}' configuration: {1}. (ADFGPP0009)
