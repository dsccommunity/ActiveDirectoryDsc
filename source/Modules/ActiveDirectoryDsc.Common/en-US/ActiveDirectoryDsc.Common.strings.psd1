...
ConvertFrom-StringData @'
    ...
    IdentityNotMappedExceptionError     = Resolving {0} from  {1} '{2}' failed. The identity is not mapped. (ADCOMMON0061)
    ResolvingMembershipAttributeValues  = Resolving {0} values based on supplied {1} values. (ADCOMMON0062)
    TranslatingMembershipAttribute      = Translating {0} value '{1}' to {2}. (ADCOMMON0063)
    ParsingCommonNameFromDN             = Parsing CommonName value from DistinguishedName '{0}'. (ADCOMMON0064)
    ADObjectPropertyLookup              = Looking up AD Object based on {0} '{1}' to retrieve {2} value. (ADCOMMON0065)
'@
